      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-16 pt-40 pb-24">
        <div className="max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row gap-5 mb-20">
            <Link href="/project" className="group px-9 py-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-2xl font-bold text-lg flex items-center justify-center gap-3 hover:shadow-2xl hover:shadow-purple-400/50 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
              Explore Our Work
